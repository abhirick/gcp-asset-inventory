...
<div class="shell">
  ...
  <div class="hero">
    ...
    <div class="hero-sub">A modern inventory dashboard built from Cloud Asset Search and Cloud Asset List results.</div>
    <div class="stats">
      <div class="stat-pill">
      ...
      <main class="content">
        ...
        <div class="section">
          <div class="section-header">
            ...
            <span class="section-count">{{ assets | length }} items</span>
          </div>
